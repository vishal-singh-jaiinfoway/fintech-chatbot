...
export default function Dashboard() {
  ...
  const apiUrl = `${process.env.NEXT_PUBLIC_API_URL}/personalized-advice-api`;
  ...
  const suggestedQuestions = [
    "What are the current cash flow trends in my business?",
    "How can I improve my cash flow?",
    "Where are the major expenses in my business?",
    ...
    <div className="h-screen flex flex-col bg-gray-50">
      ...
      <header className="bg-blue-600 text-white py-4 px-6 shadow-md">
        <div className="container mx-auto">
          <h1 className="text-3xl font-bold">Personalized Advice</h1>
        </div>
      </header>
